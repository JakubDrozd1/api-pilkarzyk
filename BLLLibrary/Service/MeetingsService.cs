    ...
    public class MeetingsService(IUnitOfWork unitOfWork) : IMeetingsService
    {
        ...
        public async Task AddMeetingAsync(GetUsersMeetingsRequest getUsersMeetingsRequest)
        {
            ...
            try
            {
                ...
                if (!(bool)getUsersMeetingsRequest.Meeting.IS_QUEST!)
                {
                ...
                if((bool)getUsersMeetingsRequest.Meeting.IS_QUEST! && getUsersMeetingsRequest.DateQuest?.Length > 0)
                {
                    ...
                    {
                        dateQuest.IDMEETING = meeetingAdded?.ID_MEETING ?? throw new Exception("Meeting is null");
        ...
        {
            _unitOfWork.UpdateMeetingsRepository.UpdateMeeting(meeting);
        }
