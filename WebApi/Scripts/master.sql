...
--    WAITING_TIME_DECISION  INTEGER DEFAULT 60 NOT NULL
--);
...
--    IDUSER                          INTEGER NOT NULL,
--    MEETING_NOTIFICATION            BOOLEAN DEFAULT true NOT NULL,
--    GROUP_INV_NOTIFICATION          BOOLEAN DEFAULT true NOT NULL,
--    MEETING_ORGANIZER_NOTIFICATION  BOOLEAN DEFAULT true NOT NULL,
--    TEAM_NOTIFICATION               BOOLEAN DEFAULT true NOT NULL,
--    UPDATE_MEETING_NOTIFICATION     BOOLEAN DEFAULT true NOT NULL,
--    TEAM_ORGANIZER_NOTIFICATION     BOOLEAN DEFAULT true NOT NULL,
--    GROUP_ADD_NOTIFICATION          BOOLEAN DEFAULT true NOT NULL,
--    MEETING_CANCEL_NOTIFICATION     BOOLEAN DEFAULT true NOT NULL
--);
--ALTER TABLE NOTIFICATION ADD CONSTRAINT NOTIFICATION_PK PRIMARY KEY (ID_NOTIFICATION);
--ALTER TABLE NOTIFICATION ADD CONSTRAINT FK_NOTIFICATION_1 FOREIGN KEY (IDUSER) REFERENCES USERS (ID_USER);


--CREATE TABLE ADS (
--    ID_AD       INTEGER GENERATED BY DEFAULT AS IDENTITY,
--    DATE_START  TIMESTAMP NOT NULL,
--    DATE_END    TIMESTAMP NOT NULL,
--    CONTENT     BLOB SUB_TYPE 1 SEGMENT SIZE 80,
--    URL         VARCHAR(300)
--);
--ALTER TABLE ADS ADD CONSTRAINT ADS_PK PRIMARY KEY (ID_AD);
